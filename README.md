...
- **⚛️ React hooks** — `useOredataState`, `useMinerAccount`, `useBidTracker`, `useRoundTiming`
...
**Latest: v0.9.5** — `isHistorical` flag for cold load detection, round history API documentation
