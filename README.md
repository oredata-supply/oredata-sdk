...
// Send a message (unified ore.supply ecosystem!)
// First call: wallet prompts for signature
// Subsequent calls: uses cached JWT (24 hours)
...
Sessions are cached both locally and on the API server — users only sign once per 24 hours, even across page refreshes!
