...
export class OredataClient {
  ...
  /**
   * Get the internal StateClient for advanced use cases.
   * 
   * @deprecated Use `client.start()` and `client.stop()` for polling control.
   * This method is kept for backward compatibility with developer tools
   * and dashboards that need low-level access.
   * 
   * @internal
   */
...
// Legacy types for backward compatibility (used by examples/dashboard)
export type { StateStoreSnapshot, RoundFrame, AppMode };
