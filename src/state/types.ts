...
export interface RoundSnapshot {
  ...
  /**
   * Global pooled per-tile bid distribution percentiles (lamports as decimal strings).
   * Present when the API includes smart bid distribution data for the round.
   */
...
export interface RoundFrameGlobals {
  ...
  /** Actual network slot duration in ms (default 400, updated from Solana stats) */
