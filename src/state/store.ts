...
export class StateStore {
  ...
  applySnapshot(snapshot: StateV3Response): void {
    ...
    // Always try to emit winner for finalized round
    // The revealedWinners Set prevents duplicate emissions
    // This ensures late-arriving winner data (after API delay) is never dropped
