...
// Legacy hooks (deprecated - use useStore instead)
export { useOredataState, type UseOredataStateOptions, type UseOredataStateReturn } from './useOredataState.js';
export { useOredataEvents, type UseOredataEventsOptions } from './useOredataEvents.js';
