...
export function useOredataState(options: UseOredataStateOptions = {}): UseOredataStateReturn {
  ...
  // Note: We don't auto-clear winner on round change.
  // The overlay naturally hides when phase changes from RESULT to BETTING.
  // This allows late-arriving winner events to still be shown briefly.
