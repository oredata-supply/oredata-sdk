...
- `RoundData.bidDistributionGlobal` — global pooled p50/p80/p99 bid size percentiles (lamports) surfaced from `/v3/state` for smart bid preset UIs.
- API reference updates for `GET /v3/rounds/:roundId/bid-distribution/tiles` (per-tile live percentiles).
